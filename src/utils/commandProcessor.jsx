  ...
  switch (cmd) {
      ...
      return (
        <div className="text-green-400">
          ...
          <ul className="list-disc list-inside ml-4">
            ...
            <li><span className="text-blue-400">image</span>               - Display user portrait</li>
    ...
    case 'whoami':
      return (
        <div className="ascii-portrait">
          <pre className="text-green-400 whitespace-pre-wrap">{asciiName}</pre>
        </div>
      );
      case 'image':
      return (
    ...
    case 'projects': {
      ...
      if(fileSystem[projectsPath] && fileSystem[projectsPath].type === 'dir') {
        ...
        const rootProjectsPath = '/home/anugraheeth/projects';
        if(fileSystem[rootProjectsPath] && fileSystem[rootProjectsPath].type === 'dir') {
          return processCommand('ls /home/anugraheeth/projects', currentPath, setCurrentPath);
        } else {
